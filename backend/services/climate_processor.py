...
class ClimateProcessor:
    @staticmethod
    def process_openmeteo_data(lat: float, lon: float, anios: str, raw_data: dict) -> dict[Season, PercentilesEstacionales]:
    ...
    @staticmethod
    def process_nasa_data(lat: float, lon: float, anios: str, raw_data: dict) -> dict[Season, PercentilesEstacionales]:
    ...
    def _calcular_percentiles_array(
        lat: float, lon: float, meses: np.ndarray, temps: np.ndarray,
        vientos: np.ndarray, radiaciones: np.ndarray, fuente: str, anios: str
