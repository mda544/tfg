...
async def list_lines(
    ...
    return await lines_service.get_all(db, user)
...
async def create_line(
    ...
    return await lines_service.create(db, data, user)
...
async def get_line(
    ...
    return await lines_service.get_by_id(db, line_id, user)
...
async def update_line(
    ...
    return await lines_service.update(db, line_id, data, user)
...
async def delete_line(
    ...
    await lines_service.delete(db, line_id, user)