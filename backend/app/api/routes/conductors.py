...
async def list_conductors(
    ...
    return await conductors_service.get_all(db, user.id)
...
async def create_conductor(
    ...
    return await conductors_service.create(db, data, user.id)
...
async def get_conductor(
    ...
    return await conductors_service.get_by_id(db, conductor_id, user.id)
...
async def update_conductor(
    ...
    return await conductors_service.update(db, conductor_id, data, user.id)
...
async def delete_conductor(
    ...
    await conductors_service.delete(db, conductor_id, user.id)
